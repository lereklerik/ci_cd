...
Commit message: "change filebeat"
 ...
 > git rev-list --no-walk 1dd34dc3a469908f7d8f05a98cd27e385468590e # timeout=10
[Pipeline] }
[Pipeline] // stage
[Pipeline] stage
[Pipeline] { (Ansible playbook)
[Pipeline] sh
+ ansible-playbook -i inventory/elk/hosts.yml site.yml --check --diff
...
PLAY RECAP *********************************************************************
elk-centos                 : ok=23   changed=0    unreachable=0    failed=0    skipped=4    rescued=0    ignored=0   
